...
- `implementation-plan` has an optional human-authored `human_intent` trust
  ...
  `"${AFS_BIN:-${AFS_CLI:-afs}}" schema validate --schema implementation-plan --file <plan.json> --skeleton <human-plan.json> --json`
