...
const SYSTEM_GUIDANCE = [
  ...
  "Prefer the blessed AFS default surface first: afs_local_context_status, afs_local_context_query, afs_local_context_diff/freshness, afs_local_context_read/list, afs_local_task_list, afs_local_handoff_list/read/create, afs_local_memory_status/search, and other lightweight reads.",
  "Prefer the repo-local slash commands /afs-brief, /afs-help, /afs-status, /afs-query, /afs-tasks, /afs-handoff, /afs-handoff-create, /afs-review-context, /afs-refresh, and /afs-pack when they match the user's intent.",
  "Planner and reviewer subagents should stay on cheap AFS reads. Worker-style agents may read or write repo-local .context files, create tasks, and create handoffs when that materially helps the work.",
