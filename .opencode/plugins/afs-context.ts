...
const SYSTEM_GUIDANCE = [
  ...
  "Prefer repo-local slash commands for richer AFS intents: /afs-next, /afs-brief, /afs-help, /afs-status, /afs-query, /afs-files, /afs-tasks, /afs-handoff, /afs-handoff-create, /afs-review-context, /afs-work-preflight, /afs-verify, /afs-missions, /afs-approvals, /afs-schema, /afs-optimize, /afs-refresh, /afs-pack, and /afs-update-work.",
