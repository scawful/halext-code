...
describe("commandName", () => {
  ...
  test("skips execution-wrapper flags and their operands", () => {
    ...
    expect(commandName("env -ia custom gchat post")).toBe("gchat")
    expect(commandName("env --block-signal gchat post")).toBe("gchat")
...
describe("detectCommand", () => {
  ...
  test("flags comms behind execution wrappers with flags", () => {
    ...
    expect(detectCommand("env -a custom gchat post hi")).toBe("Google Chat")
    expect(detectCommand("env -ia custom gchat post hi")).toBe("Google Chat")
    expect(detectCommand("env --block-signal gchat post hi")).toBe("Google Chat")
    expect(detectCommand("env --block-signal=INT gchat post hi")).toBe("Google Chat")
    expect(detectCommand("env --default-signal gchat post hi")).toBe("Google Chat")
    expect(detectCommand("env --ignore-signal gchat post hi")).toBe("Google Chat")
    expect(detectCommand("env --list-signal-handling gchat post hi")).toBe("Google Chat")
